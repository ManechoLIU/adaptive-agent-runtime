...
class InstallMigrationContractTests(unittest.TestCase):
    ...
    def test_runtime_release_gate_includes_host_ownership_and_yield_enforcement_regressions(self):
        ...
        required_tests = {
            ...
            "tests.test_web_lifecycle_bridge.WebLocalReentryIntegrationTests.test_result_unknown_unresolved_retries_reconciliation_only_after_host_fingerprint_change",
